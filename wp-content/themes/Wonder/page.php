...
<head>
	...
	<!-- Theme CSS -->
	<link rel="stylesheet" href="/wp-content/themes/Wonder/blog-site-templates/css/style.css">
...
<body>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-sm-center text-md-left">
					...
					<li class="nav-item">
					    <a class="nav-link" href="/wp-content/themes/Wonder/page.php"><i class="fas fa-file-alt fa-fw mr-2"></i>About Us</a>
					</li>
					<li class="nav-item">
    ...
    <div class="main-wrapper">
	    <header class="page-title theme-bg-light text-center gradient py-5">
			<h1 class="heading-test">Blog Home Page Heading</h1>
		</header>
	    ...
	    <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <p class="copyright"><a href="">By Ties en Patrick</a></p>
